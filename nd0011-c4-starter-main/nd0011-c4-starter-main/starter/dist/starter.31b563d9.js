...
const renderCardSetsPage = ()=>{
    ...
    toggleFormButton.setAttribute("data-cy", "create-set-btn");
...
const createSetForm = (setCards)=>{
    ...
    input.setAttribute("data-cy", "input-set-name"); // <<<< أضف هذا السطر فقط
    const submitButton = (0, _utilityRenderFunctionsJs.createSubmitButton)("Submit Set");
    submitButton.setAttribute("data-cy", "submit-btn"); // <<<< وأضف هذا السطر فقط
